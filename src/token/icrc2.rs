...
/// 授权对象
pub type Icrc2AllowanceArgs = icrc_ledger_types::icrc2::allowance::AllowanceArgs;
...
/// 授权额度
pub type Icrc2Allowance = icrc_ledger_types::icrc2::allowance::Allowance;
// #[derive(CandidType, Serialize, Deserialize, Debug, Clone)]
...
/// 授权参数
pub type Icrc2ApproveArgs = icrc_ledger_types::icrc2::approve::ApproveArgs;
// #[derive(CandidType, Serialize, Deserialize, Debug, Clone)]
...
/// 授权错误
pub type Icrc2ApproveError = icrc_ledger_types::icrc2::approve::ApproveError;
// #[derive(CandidType, Serialize, Deserialize, Debug, Clone)]
...
/// 转账参数
pub type Icrc2TransferFromArgs = icrc_ledger_types::icrc2::transfer_from::TransferFromArgs;
// #[derive(CandidType, Serialize, Deserialize, Debug, Clone)]
...
// }
/// 转账可能出现的错误
pub type Icrc2TransferFromError = icrc_ledger_types::icrc2::transfer_from::TransferFromError;
// #[derive(CandidType, Serialize, Deserialize, Debug, Clone)]
